...
results_lda = linear_discriminant_analysis(data_filtered, solver=solver_lda, shrinkage=shrinkage, tol=tol,
                             store_covariance=store_covariance, plot=True)
...
results_qda = quadratic_discriminant_analysis(data_filtered, reg_param=reg_param, tol=tol, store_covariance=True, plot=True)
